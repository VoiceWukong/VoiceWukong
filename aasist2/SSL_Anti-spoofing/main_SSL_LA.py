...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--database_path",
        type=str,
        default="/home/ydoit/AIGC/Eva/CD_ADD/",
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="/home/ydoit/AIGC/Eva/aasist2/SSL_Anti-spoofing/models_noAD/model_LA_WCE_100_14_1e-06/epoch_99.pth",
    ...
    model_save_path = os.path.join("models_muilt_domain_noAD", model_tag)
    ...
    if args.eval:
        file_eval = genSpoof_list(
            dir_meta=os.path.join(args.protocols_path + "dev_train.txt"),
            is_train=False,
            is_eval=True,
        )
        ...
        eval_set = Dataset_ASVspoof2021_eval(
            list_IDs=file_eval,
            base_dir=os.path.join(args.database_path + "dev_train.txt"),
        )
    ...
    d_label_dev, file_dev = genSpoof_list(
        dir_meta=os.path.join(args.protocols_path + "dev_eva.txt"),
        is_train=False,
        is_eval=False,
    )
