...
## Models
- download the weighted model [here](https://huggingface.co/VoiceWukong/VoiceWukong/resolve/main/Rawnet2-Vocoder.pth?download=true)
...
- change the path to your **RawNet2-Vocoder** ``zh_eval_score.txt`` and ``en_eval_score.txt`` in ``analysis.ipynb`` file 
