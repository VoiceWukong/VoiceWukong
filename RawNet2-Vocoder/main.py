...
class Dataset_LibriSeVoc(Dataset):
    ...
    def __init__(self, dataset_path, protocol_file='/home/ydoit/AIGC/Eva/LA/ASVspoof2019_LA_cm_protocols/',split = 'train'):
            self.dataset_path = dataset_path+split+'/flac'
            if split == 'train':
                self.protocol_file = protocol_file + 'ASVspoof2019.LA.cm.train.trn.txt'
            elif split == 'dev':
                self.protocol_file = protocol_file + 'ASVspoof2019.LA.cm.dev.trl.txt'
            else:
                self.protocol_file = protocol_file + 'ASVspoof2019.LA.cm.eval.trl.txt'
            # y_list_train = []
            # path_list_train = []
            ...
            for line in audio_lines:
                sp_id,audio_path,sys_id,_,label=line.strip().split(' ')
                path_list.append(os.path.join(self.dataset_path,audio_path+'.flac'))
...
if __name__ == '__main__':
    ...
    data_path = '/home/ydoit/AIGC/Eva/LA/ASVspoof2019_LA_'
    model_save_path = '/home/ydoit/AIGC/Eva/AI-Synthesized/Synthetic-Voice-Detection-Vocoder-Artifacts/model'
    batch_size = 32
    num_epochs = 100
    lr = 0.0001
    weight_decay = 0.0001
