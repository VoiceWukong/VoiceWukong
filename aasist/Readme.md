...
- change "model_path" in the ``config/AASIST.conf`` file to the downloaded weighted model
...
- change the path to your **AASIST** ``zh_eval_score.txt`` and ``en_eval_score.txt`` in ``analysis.ipynb`` file 
