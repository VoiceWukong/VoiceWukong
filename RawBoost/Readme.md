...
## Models
- download the weighted model [here](https://huggingface.co/VoiceWukong/VoiceWukong/resolve/main/RawBoost.pth?download=true)
...
- change the path to your **RawBoost** ``zh_eval_score.txt`` and ``en_eval_score.txt`` in ``analysis.ipynb`` file 
