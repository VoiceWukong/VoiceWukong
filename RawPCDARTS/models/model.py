...
class Network(nn.Module):
  ...
  def __init__(self, C, layers, nfft,hop,sr,is_log,is_cmvn,nfilter,num_ceps, num_classes, genotype, front_end):
    ...
    if front_end == 'Spectrogram':
      self.feature = Spectrogram(nfft, nfft//hop, nfft, sr, is_log, is_cmvn)
      print('*****Using Spectrogram front end*****')
    elif front_end == 'LFCC':
      self.feature = LFCC(nfft, nfft//hop, nfft, sr, nfilter, num_ceps, is_cmvn)
      print('*****Using LPCC front end*****') 
    elif front_end == 'LFB':
      self.feature = LFB(nfft, nfft//hop, nfft, sr, nfilter, num_ceps, is_cmvn)
