...
class ASVRawTest(data.Dataset):
    ...
    def __getitem__(self, index):
        feature_path,variant, file_name, random_token,attack_id, sys_id = self.features[index]
        feature = self.load_feature(feature_path)
        return feature, variant,file_name,random_token, attack_id, sys_id
