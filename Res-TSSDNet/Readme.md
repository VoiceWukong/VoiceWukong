...
## Models
- download the weighted model [here](https://huggingface.co/VoiceWukong/VoiceWukong/resolve/main/ResTSSDNet.pth?download=true)
...
- change the path to your **Res-TSSDNet** ``zh_eval_score.txt`` and ``en_eval_score.txt`` in ``analysis.ipynb`` file 
